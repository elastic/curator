...
class CuratorTestCase(TestCase):
    ...
    def create_snapshot(self, name, csv_indices):
        ...
        self.client.snapshot.create(
            repository=self.args['repository'], snapshot=name, ignore_unavailable=False,
            include_global_state=True, partial=False, indices=csv_indices,
    ...
    def invoke_runner(self, dry_run=False):
        if dry_run:
            self.result = self.runner.invoke(cli,
