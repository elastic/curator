...
class TestActionFileAlias(CuratorTestCase):
    def test_add_only(self):
        ...
        self.write_config(self.args['actionfile'], testvars.alias_add_only.format(alias))
    ...
    def test_add_only_with_extra_settings(self):
        alias = 'testalias'
        self.write_config(self.args['configfile'], testvars.client_config.format(HOST))
        self.write_config(self.args['actionfile'], testvars.alias_add_only_with_extra_settings.format(alias))
        self.create_index('my_index')
        self.invoke_runner()
        expected = {
            'my_index': {
    ...
    def test_alias_remove_only(self):
        alias = 'testalias'
        self.write_config(self.args['configfile'], testvars.client_config.format(HOST))
        self.write_config(self.args['actionfile'], testvars.alias_remove_only.format(alias))
    ...
    def test_add_with_empty_remove(self):
        alias = 'testalias'
        self.write_config(self.args['configfile'], testvars.client_config.format(HOST))
        self.write_config(self.args['actionfile'], testvars.alias_add_with_empty_remove.format(alias))
        idx1, idx2 = ('dummy', 'my_index')
        self.create_index(idx1)
        self.create_index(idx2)
        self.client.indices.put_alias(index=idx1, name=alias)
    ...
    def test_remove_with_empty_add(self):
        alias = 'testalias'
        self.write_config(self.args['configfile'], testvars.client_config.format(HOST))
        self.write_config(self.args['actionfile'], testvars.alias_remove_with_empty_add.format(alias))
        idx1, idx2 = ('dummy', 'my_index')
        self.create_index(idx1)
        self.create_index(idx2)
    ...
    def test_add_with_empty_list(self):
        alias = 'testalias'
        self.write_config(self.args['configfile'], testvars.client_config.format(HOST))
        self.write_config(self.args['actionfile'], testvars.alias_add_remove_empty.format(alias, 'du', 'rickroll'))
        idx1, idx2 = ('dummy', 'my_index')
        self.create_index(idx1)
        self.create_index(idx2)
        self.client.indices.put_alias(index=idx1, name=alias)
    ...
    def test_remove_with_empty_list(self):
        alias = 'testalias'
        self.write_config(self.args['configfile'], testvars.client_config.format(HOST))
        self.write_config(self.args['actionfile'], testvars.alias_add_remove_empty.format(alias, 'rickroll', 'my'))
        idx1, idx2 = ('dummy', 'my_index')
        self.create_index(idx1)
        self.create_index(idx2)
        self.client.indices.put_alias(index=idx1, name=alias)
    ...
    def test_remove_index_not_in_alias(self):
        alias = 'testalias'
        self.write_config(self.args['configfile'], testvars.client_config.format(HOST))
        self.write_config(self.args['actionfile'], testvars.alias_remove_index_not_there.format(alias,'my'))
    ...
    def test_no_add_remove(self):
        alias = 'testalias'
        self.write_config(self.args['configfile'], testvars.client_config.format(HOST))
        self.write_config(self.args['actionfile'], testvars.alias_no_add_remove.format(alias))
        idx1, idx2 = ('dummy', 'my_index')
        self.create_index(idx1)
        self.create_index(idx2)
        self.invoke_runner()
    ...
    def test_extra_options(self):
        self.write_config(self.args['configfile'], testvars.client_config.format(HOST))
        self.write_config(self.args['actionfile'], testvars.bad_option_proto_test.format('alias'))
        self.invoke_runner()
        assert 1 == self.result.exit_code
