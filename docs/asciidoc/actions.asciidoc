...
For more information see the {ref}/modules-snapshots.html[official Elasticsearch Documentation].
...
{ref}/indices-shrink-index.html#_shrinking_an_index[Several conditions need to be met]
